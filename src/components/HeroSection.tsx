export default function HeroSection() {
  return (
    <section className="relative bg-gradient-to-r from-[#800020] to-[#600018] text-white py-16 md:py-24">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-white text-[#800020] px-8 py-3 rounded-md font-semibold hover:bg-gray-100 transition-colors">
              Shop New Arrivals
            </button>
