...
export default function FlashSale({ products }: { products: Product[] }) {
    ...
    // Filter real products for Flash Sale
    ...
    if (flashSaleProducts.length === 0) return null; // Hide if no flash sales active
        ...
        <section className="py-24 px-4 sm:px-6 lg:px-8 bg-linear-to-b from-black to-black/50">
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-16">
                    ...
                    <h2 className="text-4xl md:text-5xl lg:text-6xl mb-6 text-white">Flash Sale</h2>
                    ...
                    <div className="flex items-center justify-center space-x-6">
                        {['hours', 'minutes', 'seconds'].map((unit) => (
                            <div key={unit} className="flex items-center">
                                ...
                                {unit !== 'seconds' && <span className="text-3xl text-gold mx-6 mb-6">:</span>}
                            </div>
                        ))}
                    </div>
                </div>
