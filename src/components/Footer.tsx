        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#" className="hover:text-gray-200 transition-colors">Track Order</a></li>
              <li><a href="#" className="hover:text-gray-200 transition-colors">Returns</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#" className="hover:text-gray-200 transition-colors">Shipping Policy</a></li>
              <li><a href="#" className="hover:text-gray-200 transition-colors">Refund Policy</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-2">
              ...
              />
              <button className="bg-white text-[#800020] px-4 py-2 rounded hover:bg-gray-100 transition-colors">
